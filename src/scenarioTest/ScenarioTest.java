...
public class ScenarioTest {
	...
	public static void main(String[] args) {
		...
		System.out.println(marche[0].etalEtal());
		System.out.println(marche[1].etalEtal());
		System.out.println(marche[2].etalEtal());

		acheterProduit(marche, "sanglier", 3);
		// j'ai d'abord mis obélix dans le marché donc on achète a Obélix puis à Astérix
